    ...
    <div class="login bg-light">
        ...
        <div class="d-flex justify-content-center align-items-center vh-100">
            <div class="d-flex max-w-4xl mt-5">
                    ...
                    <form @submit.prevent="loginUser">
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                class="form-control"
                            />
                            <p v-if="!validated.password" class="text-danger mt-1">Mật khẩu phải gồm ít nhất chữ thường, số và không được dưới 8 kí tự.</p>
                        </div>
                ...
                <div class="form-img">
                        <a href="index.html"><img src="/src/assets/data/img/sign/logo.png" alt=""></a>   
                        <a title="Sign-up" href="signup.html" class="sign-link mt-3">Đăng Ký</a>
                    </div>
            </div>
        </div>
    </div>
